                ...
                <OuterContainer>
                    ...
                    <AllInputContainer>
                        ...
                        <FormControl variant="filled" sx={{ m: 1, mt: 1, width: '40ch', marginBottom:'20px', '& .MuiInputLabel-root': {
                            ...
                            <InputLabel htmlFor="filled-adornment-amount">Post Garduate Grade</InputLabel>
                            <FilledInput
                            id="filled-adornment-amount"
                            // value={values.senderaccount}
                            // onChange={handleChange('senderaccount')}
                        ...
                        <FormControl variant="filled" sx={{ m: 1, mt: 1, width: '40ch', marginBottom:'20px', '& .MuiInputLabel-root': {
                            ...
                            <InputLabel htmlFor="filled-adornment-amount">Under Graduate</InputLabel>
                            <FilledInput
                            id="filled-adornment-amount"
                            // value={values.senderaccount}
                            // onChange={handleChange('senderaccount')}
                        ...
                        <FormControl variant="filled" sx={{ m: 1, mt: 1, width: '40ch', marginBottom:'20px', '& .MuiInputLabel-root': {
                            ...
                            <InputLabel htmlFor="filled-adornment-amount">XII Grade</InputLabel>
                            <FilledInput
                            id="filled-adornment-amount"
                            // value={values.senderaccount}
                            // onChange={handleChange('senderaccount')}
                        ...
                        <FormControl variant="filled" sx={{ m: 1, mt: 1, width: '40ch', marginBottom:'20px', '& .MuiInputLabel-root': {
                            ...
                            <InputLabel htmlFor="filled-adornment-amount">X Grade</InputLabel>
                            <FilledInput
                            id="filled-adornment-amount"
                            // value={values.senderaccount}
                            // onChange={handleChange('senderaccount')}
                        ...
                        <FormControl variant="filled" sx={{ m: 1, mt: 1, width: '40ch', marginBottom:'20px', '& .MuiInputLabel-root': {
                            ...
                            <InputLabel htmlFor="filled-adornment-amount">Any Other Qualification</InputLabel>
                            <FilledInput
                            id="filled-adornment-amount"
                            // value={values.senderaccount}
                            // onChange={handleChange('senderaccount')}
