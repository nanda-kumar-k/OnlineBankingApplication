        ...
        <>
            ...
            <SliderContainer>
                <OuterContainer>
                    ...
                    <AllInputContainer>
                        <InputContainer>
                        <h2>Enter Identification Details</h2>
                        <br/>
                        ...
                        <NotePointContainer>
                            ...
                            <ul>
                                <li><p>please enter 12 digit individual identification number issued by the Unique Identification Authority of India</p></li>
                                <li><p>please enter the PAN (or PAN number) is a ten-character long alpha-numeric unique identifier. The first five characters are letters (in uppercase by default), followed by four numerals, and the last (tenth) character is a letter.</p></li>
